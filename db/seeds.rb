...
10.times do 
    Interest.create!(name: Faker::Commerce.unique.department, user: User.all.sample, topic: Topic.all.sample, description: Faker::Movie.unique.quote, level: Faker::Number.within(range: 1..10))
end